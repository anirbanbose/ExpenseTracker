...
public class DomainResult : Result
{
    ...
    public static DomainResult SuccessResult() => new() { IsSuccess = true };
    public static new DomainResult DomainValidationFailureResult(Error error) => new() { ErrorMessage = error.Message, Code = error.Code, IsSuccess = false };
    public static new DomainResult DomainValidationFailureResult(string errorCode, string errorMessage) => new() { ErrorMessage = errorMessage, Code = errorCode, IsSuccess = false };
}
