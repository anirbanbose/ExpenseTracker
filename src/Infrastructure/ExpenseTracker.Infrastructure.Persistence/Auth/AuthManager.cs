...
namespace ExpenseTracker.Infrastructure.Persistence.Auth
{
    public class AuthManager : IAuthManager
    {
        ...
        public AuthManager(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, ILogger<AuthManager> logger)
        {
